...
|---|---|---|
| npm | Live at 0.4.11 | [`@coaspe/sap-abap-mcp`](https://www.npmjs.com/package/@coaspe/sap-abap-mcp) has version 0.4.11 on `latest`; the manual `Publish npm` workflow uses npm Trusted Publishing |
...
| Codex repository marketplace | Live at 0.4.11 | Public GitHub marketplace installs as `sap-abap-mcp@coaspe-sap` and starts the 0.4.11 npm `latest` runtime |
