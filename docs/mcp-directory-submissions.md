...
|---|---|---|
| npm | 1.5.2 release pending | [`@coaspe/sap-abap-mcp`](https://www.npmjs.com/package/@coaspe/sap-abap-mcp) will be published through the provenance-enabled workflow after the release commit is merged |
| Official MCP Registry | 1.5.2 release pending | [`io.github.Coaspe/sap-abap-mcp`](https://registry.modelcontextprotocol.io/v0.1/servers?search=io.github.Coaspe/sap-abap-mcp) will be published through the GitHub OIDC workflow after npm 1.5.2 is public |
| GitHub Release | 1.5.2 release pending | The verified MCPB and SHA-256 checksum will be attached to `v1.5.2` |
...
| Claude Desktop MCPB directory | v1.5.2 update pending | The prior v1.0.0 update was submitted on 2026-07-29; the validated v1.5.2 MCPB will be attached to GitHub Release and needs a new Anthropic directory submission |
| Codex repository marketplace | 1.5.2 release pending | Public GitHub marketplace installs as `sap-abap-mcp@coaspe-sap`; its manifest uses the shared `.mcp.json` full-surface configuration verified with Codex 0.137.0 |
