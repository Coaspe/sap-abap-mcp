...
- Current source release: `1.5.1`
- Currently published version: `1.5.1`
...
|---|---|---|
| npm | Live at 1.5.1 | [`@coaspe/sap-abap-mcp`](https://www.npmjs.com/package/@coaspe/sap-abap-mcp) has version 1.5.1 on `latest`; the provenance-enabled [publish run](https://github.com/Coaspe/sap-abap-mcp/actions/runs/32916616587) completed successfully |
| Official MCP Registry | Live at 1.5.1 | [`io.github.Coaspe/sap-abap-mcp`](https://registry.modelcontextprotocol.io/v0.1/servers?search=io.github.Coaspe/sap-abap-mcp) exposes 1.5.1 as `isLatest: true`; the GitHub OIDC [publish run](https://github.com/Coaspe/sap-abap-mcp/actions/runs/32916692276) completed successfully |
| GitHub Release | Complete | [`v1.5.1`](https://github.com/Coaspe/sap-abap-mcp/releases/tag/v1.5.1) includes release notes, `sap-abap-mcp-1.5.1.mcpb`, and its SHA-256 checksum |
| Smithery | Live with 120 tools | [`aspalt85/sap-abap-mcp`](https://smithery.ai/servers/aspalt85/sap-abap-mcp) accepted deployment `638b38b3-66b6-42d3-8cc7-88d0fd882068` with status `SUCCESS` and the complete 120-tool runtime schemas |
...
| Claude Desktop MCPB directory | v1.5.1 update pending | The prior v1.0.0 update was submitted on 2026-07-29; the validated v1.5.1 MCPB is attached to GitHub Release and needs a new Anthropic directory submission |
| Codex repository marketplace | Live at 1.5.1 | Public GitHub marketplace installs as `sap-abap-mcp@coaspe-sap`; its manifest uses the shared `.mcp.json` full-surface configuration verified with Codex 0.137.0 |
