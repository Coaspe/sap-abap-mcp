...
- Current source release: `1.5.2`
- Currently published version: `1.5.2`
...
|---|---|---|
| npm | Live at 1.5.2 | [`@coaspe/sap-abap-mcp`](https://www.npmjs.com/package/@coaspe/sap-abap-mcp) has version 1.5.2 on `latest`; the provenance-enabled [publish run](https://github.com/Coaspe/sap-abap-mcp/actions/runs/32917521905) completed successfully |
| Official MCP Registry | Live at 1.5.2 | [`io.github.Coaspe/sap-abap-mcp`](https://registry.modelcontextprotocol.io/v0.1/servers?search=io.github.Coaspe/sap-abap-mcp) exposes 1.5.2 as `isLatest: true`; the GitHub OIDC [publish run](https://github.com/Coaspe/sap-abap-mcp/actions/runs/32917586019) completed successfully |
| GitHub Release | Complete | [`v1.5.2`](https://github.com/Coaspe/sap-abap-mcp/releases/tag/v1.5.2) includes release notes, `sap-abap-mcp-1.5.2.mcpb`, and its SHA-256 checksum |
| Smithery | Live with 120 tools | [`aspalt85/sap-abap-mcp`](https://smithery.ai/servers/aspalt85/sap-abap-mcp) accepted deployment `e528a691-53a1-4db7-bd8a-b259027c0acf` with status `SUCCESS` and the complete 120-tool runtime schemas |
...
| Claude Desktop MCPB directory | v1.5.2 update pending | The prior v1.0.0 update was submitted on 2026-07-29; the validated v1.5.2 MCPB is attached to GitHub Release and needs a new Anthropic directory submission |
| Codex repository marketplace | Live at 1.5.2 | Public GitHub marketplace installs as `sap-abap-mcp@coaspe-sap`; Codex 0.137.0 accepted the plugin, and direct adaptive registration completed a search, describe, and read-gateway invocation |
...
| MCP Servers | Live; 1.4.0 refresh pending | [`coaspe/sap-abap-mcp`](https://mcpservers.org/servers/coaspe/sap-abap-mcp) displays repository README content; refresh its index after the 1.4.0 README reaches the default branch |
...
| Cline MCP Marketplace | Submitted; review pending | [`cline/mcp-marketplace#2030`](https://github.com/cline/mcp-marketplace/issues/2030) is open with v1.4.0 release and 120-tool validation details |
