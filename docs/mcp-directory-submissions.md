...
|---|---|---|
| npm | Live at 0.4.8 | [`@coaspe/sap-abap-mcp`](https://www.npmjs.com/package/@coaspe/sap-abap-mcp) has version 0.4.8 on `latest`; GitHub Actions run [`29392966672`](https://github.com/Coaspe/sap-abap-mcp/actions/runs/29392966672) published it through npm Trusted Publishing |
| Official MCP Registry | Live at 0.4.8 | [`io.github.Coaspe/sap-abap-mcp`](https://registry.modelcontextprotocol.io/v0.1/servers?search=io.github.Coaspe/sap-abap-mcp) reports version 0.4.8 active and latest; GitHub Actions run [`29393196323`](https://github.com/Coaspe/sap-abap-mcp/actions/runs/29393196323) published it with GitHub OIDC |
...
| Codex repository marketplace | Live at 0.4.8 | Public GitHub marketplace installs as `sap-abap-mcp@coaspe-sap` and starts the 0.4.8 npm `latest` runtime |
